...
- Last 20 `hook-performance` records from `memory` or `/opt/data/social-marketing/hook-performance.json`.
- Current `/opt/data/social-marketing/strategy.json`.
- Latest `/opt/data/social-marketing/trend-report.json`.
