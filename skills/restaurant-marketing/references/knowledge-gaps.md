...
```
read_file: /opt/data/social-marketing/knowledge-base/chef.json
read_file: /opt/data/social-marketing/knowledge-base/recipes.json
read_file: /opt/data/social-marketing/knowledge-base/history.json
read_file: /opt/data/social-marketing/photo-inventory.json
```
