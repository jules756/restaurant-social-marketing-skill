...
3. Downloads each new image to `/opt/data/social-marketing/photos/unsorted/`.
4. Appends file metadata to `/opt/data/social-marketing/photos/drive-index.json`.
...
4. Writes the aggregated inventory to `/opt/data/social-marketing/photo-inventory.json`.
