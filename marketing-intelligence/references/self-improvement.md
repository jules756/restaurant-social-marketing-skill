...
- Last 20 `hook-performance` records from `memory` or `~/social-marketing/hook-performance.json`.
- Current `~/social-marketing/strategy.json`.
- Latest `~/social-marketing/trend-report.json`.
